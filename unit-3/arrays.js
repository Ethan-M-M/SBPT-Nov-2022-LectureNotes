...
food.pop(); // removes value from end of array
console.log('Pop: ', food);

//? .shift()
food.shift(); // removes value in the first position of array
console.log('Shift: ', food);

//? .unshift()
food.unshift('Hamburger', 'Salad'); // adds to the front of the array
// can include multiple items
console.log('Unshift: ', food);

//? .length
console.log("Length: ", food.length); // handled like a property, returns number of items in array
...
let fruits = [
    'apple', 'pear', 'mango', 'orange', 'pinapple'
];

// How can we use a filter to remove the mango?
...
// How can we remove any fruit that has the word "apple" in it?
...
console.log('Copied2: ', copiedFullName2);
